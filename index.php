...
<head>
    <meta charset="utf-8">
    <title>MEDIA INTERACTIVE STUDIO</title>
	...
	<!-- Theme color -->
  	<link href="assets/css/themes/turquoise.css" rel="stylesheet" id="style-color">
  ...
  <div class="container">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li class="active"><a href="#sectionLogo">home</a></li>
...
<section id="sectionLogo">
	...
	<div class="container">
		...
		<div class="info">
			<h2>Modern technology activities</h2>
...
<section id="recommend">
	<div class="container">
		<div class="header text-center">
			<h3>recommend <span>template</span></h3>
...
<section id="portfolio">
	<div class="container">
		...
		<div class="header">
			<h3>fresh<br>designs</h3>
			
			<div class="row">
				<div class="col-md-6"><p>Sed ut perspiciatis unde omnis iste natus voluptatem<br>accusantium doloremque laudantium.</p></div>
    	...
    	<div id="portfolioProject">
        	...
        	<ul class="list-unstyled row m-b-20">
            	<li class="col-md-2 col-sm-3 col-xs-4">
                    ...
                    <a href="http://placehold.it/200x200" class="projectShow fancybox"><span class="projectGo"></span></a>
                </li>
            	<li class="col-md-4 col-sm-6 col-xs-8">
					<div class="padding-20">
						<h4 class="title">Your dreams <span>our purpose</span></h4>
	...
	<!-- about desc -->
		<div class="about">
			<div class="row">
				...
				<div class="col-md-8">
					<p><strong>Sed ut perspiciatis unde omnis iste natus</strong> error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
	...
	<!-- person car.-->
		<div class="persons">
			...
			<div class="bx-persons">
			  <div class="person">
			  	<div class="img">
			  		<img src="http://placehold.it/199x203" alt="">
					<span></span>
			  	</div>
			  	<div class="info">
					<h4>ANNA NOWAK</h4>
...
<script src="assets/plugins/jquery.scrollTo.js" type="text/javascript"></script>
